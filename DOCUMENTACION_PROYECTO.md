...
Sistema de Gestión Biotecnológica para la Pitahaya Ecuatoriana
...
Pitahaya Biotec es un **sistema de gestión web** diseñado para integrar y digitalizar los procesos de investigación, producción y comercialización de la pitahaya (Hylocereus spp.) en Ecuador. Es desarrollado para **ESPOCH** (Escuela Superior Politécnica de Chimborazo) e **INIAP** (Instituto Nacional de Investigaciones Agropecuarias).
